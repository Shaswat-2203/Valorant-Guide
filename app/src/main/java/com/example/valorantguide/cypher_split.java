...
public class cypher_split extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cypher_split);
    ...
    private void show_video() {
        ...
        img1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(cypher_split.this, Full_screen_video.class);
    ...
    private void find_recview1() {
        ...
        LinearLayoutManager layoutManager=new LinearLayoutManager(cypher_split.this,LinearLayoutManager.HORIZONTAL,false);
        recView1.setLayoutManager(layoutManager);
        FirebaseRecyclerOptions<model> options =
                new FirebaseRecyclerOptions.Builder<model>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Cypher").child("Split").child("cam_trip_a"), model.class)
                        .build();
    ...
    private void find_recview2() {
        ...
        FirebaseRecyclerOptions<model> options =
                new FirebaseRecyclerOptions.Builder<model>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Cypher").child("Split").child("cam_trip_b"), model.class)
                        .build();
    ...
    private void find_recview3() {
        ...
        FirebaseRecyclerOptions<model> options =
                new FirebaseRecyclerOptions.Builder<model>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Cypher").child("Split").child("cage_a"), model.class)
                        .build();
    ...
    private void find_recview4() {
        ...
        FirebaseRecyclerOptions<model> options =
                new FirebaseRecyclerOptions.Builder<model>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Cypher").child("Split").child("cage_b"), model.class)
                        .build();
