...
public class brimstone_ascent extends AppCompatActivity {
    ...
    private void show_video() {
        ...
        img1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(brimstone_ascent.this, Full_screen_video.class);
    ...
    private void find_recview1() {
        ...
        LinearLayoutManager layoutManager=new LinearLayoutManager(brimstone_ascent.this,LinearLayoutManager.HORIZONTAL,false);
        recView1.setLayoutManager(layoutManager);
        FirebaseRecyclerOptions<model> options =
                new FirebaseRecyclerOptions.Builder<model>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Brimstone").child("Ascent").child("smoke_a"), model.class)
                        .build();
    ...
    private void find_recview2() {
        ...
        FirebaseRecyclerOptions<model> options =
                new FirebaseRecyclerOptions.Builder<model>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Brimstone").child("Ascent").child("smoke_b"), model.class)
                        .build();
    ...
    private void find_recview3() {
        ...
        FirebaseRecyclerOptions<model> options =
                new FirebaseRecyclerOptions.Builder<model>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Brimstone").child("Ascent").child("postplant_a"), model.class)
                        .build();
    ...
    private void find_recview4() {
        ...
        FirebaseRecyclerOptions<model> options =
                new FirebaseRecyclerOptions.Builder<model>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Brimstone").child("Ascent").child("postplant_b"), model.class)
                        .build();
